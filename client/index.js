...
addButton.addEventListener("click", () => {
  ...
  const orderInfo = `${orderNumElement.textContent} (${
    closetSizeSelect.value
  })(${selectedColor})(${doorTypes[selectedImage.alt]})(${commentInput.value})`;
...
async function updateImages() {
  ...
  try {
    const response = await fetch(
      `/api/images/get_images?size=${selectedSize}&color=${selectedColor}`
    );
